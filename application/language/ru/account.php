...
$text['error_firstname'] = 'Имя введено неверно. Количество симолов от 2 до 15';
$text['error_lastname'] = 'Фамилия введена неверно. Количество симолов от 2 до 15';
$text['error_email'] = 'E-mail адрес указан неверно';
